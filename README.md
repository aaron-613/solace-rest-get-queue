...
This stateful microserve is used to provide a REST-based interface to consume/acknowledge persistent messages from Solace queues.
...
```
curl -u clientUsername:password http://localhost:9000/restQ/con/5447c6cd-985f-4369-a27b-ce6f503bdafc
...
### Prety-Print JSON representation (format=pretty)
```
curl -u clientUsername:password http://localhost:9000/restQ/con/5447c6cd-985f-4369-a27b-ce6f503bdafc?format=pretty
...
```
curl -u clientUsername:password http://localhost:9000/restQ/con/5447c6cd-985f-4369-a27b-ce6f503bdafc?format=dump
